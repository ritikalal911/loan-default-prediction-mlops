# Phase 1 — Dataset, Architecture, Pipeline & Experiment Tracking
...
![Phase 1 MLOps Architecture](../architecture/phase1_architecture.png)
...
![All MLflow Runs](../mlflow/01_all_runs.png)

#### Run Comparison

![MLflow Run Comparison](../mlflow/02_compare_runs.png)

#### Parameter Comparison

![MLflow Parameter Comparison](../mlflow/03_compare_parameters.png)

#### Metric Comparison

![MLflow Metric Comparison](../mlflow/04_compare_metrics.png)

#### Best Run

![Best MLflow Run](../mlflow/05_best_run.png)

#### Best Run Details

![Best Run Details](../mlflow/06_best_run_detail.png)

#### Model Artifact

![MLflow Model Artifact](../mlflow/07_model_artifact.png)

#### Training Output

![Model Training Output](../mlflow/08_model_training.png)
...
The repository includes the following Phase 1 screenshots and figures:

### Architecture

![Phase 1 Architecture](../architecture/phase1_architecture.png)

### Experiment Tracking

![MLflow All Runs](../mlflow/01_all_runs.png)
...
![MLflow Best Run](../mlflow/05_best_run.png)

![MLflow Best Run Details](../mlflow/06_best_run_detail.png)

![MLflow Model Artifact](../mlflow/07_model_artifact.png)

![MLflow Training Output](../mlflow/08_model_training.png)
